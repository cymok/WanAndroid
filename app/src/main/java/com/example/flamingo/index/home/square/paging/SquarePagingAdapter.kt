...
class SquarePagingAdapter :
    PagingDataAdapter<DataX, SquarePagingViewHolder>(object : DiffUtil.ItemCallback<DataX>() {
    ...
    override fun onBindViewHolder(holder: SquarePagingViewHolder, position: Int) {
        ...
        holder.binding.run {
            item?.let {
                ...
                root.setOnClickListener {
                    WebActivity.start(item, ArticlePage.SQUARE, position)
                }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SquarePagingViewHolder {
        return SquarePagingViewHolder(
...
class SquarePagingViewHolder(val binding: RvItemArticleBinding) : ViewHolder(binding.root)